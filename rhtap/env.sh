...
export IMAGE_URL=${IMAGE_URL-quay.io/rhtap_qe/dotnet-basic-wrfwynvs:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-rhdh-qe/dotnet-basic-wrfwynvs-gitops
